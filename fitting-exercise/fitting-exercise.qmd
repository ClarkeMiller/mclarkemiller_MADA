...
fit_trial <- model_trial %>% fit(Y ~ AGE * DOSE * SEX * WT * HT, data = train_data)
...
null_data %>% parsnip::fit(Y ~ AGE * DOSE * SEX * WT * HT, data = train_data)
null_fit <- model_trial %>% fit(Y ~ AGE * DOSE * SEX * WT * HT, data = train_data)
